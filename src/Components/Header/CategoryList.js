  ...
  return (
    <div className="sticky top-0 bg-white flex flex-row h-14 px-6 border-b-2 border-gray-100 shadow-md">
      ...
      <div className="group cursor-pointer flex justify-center items-center p-2 ">
        <svg className="w-6 h-6 group-hover:text-indigo-700 transform transition duration-800 ease-in-out"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
